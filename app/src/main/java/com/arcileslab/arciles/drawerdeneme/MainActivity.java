...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   this.getSupportActionBar().setHomeButtonEnabled(true);
        this.navDrawerActionBarToggle = new ActionBarDrawerToggle(this,navDrawerLayout,R.string.app_name,R.string.app_name){
            @Override
...
//        menu.findItem(R.id.action_settings).setVisible(!this.navDrawerLayout.isDrawerOpen(R.id.drawerList));
